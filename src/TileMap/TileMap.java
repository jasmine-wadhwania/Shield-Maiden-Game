...
public class TileMap {
	...
	public TileMap(int tileSize) {
		...
		numRowsToDraw = display.height / tileSize + 2;
		numColsToDraw = display.width / tileSize + 2;
		tween = 0.07;
	}
	...
	public void loadMap(String s) {
		...
		try {
			...
			xmin = display.width - width;
			xmax = 0;
			ymin = display.height - height;
			ymax = 0;
			...
			Graphics g = null;
			g.drawString("Game Over", 1550, 700);
		} catch (Exception e) {
